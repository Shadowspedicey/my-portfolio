...
export default function CTO() {
	return(
		<section id="contact" className="[&_h3]:{text-white text-white text-center font-fjalla text-xl md:text-3xl/12 tracking-wider}">
			<h2>
				<TypeAnimation
					sequence={[
			...
			<h3>I’m ready to turn ideas and business needs into clean, scalable code.</h3>
			<h3>Open to freelance projects and developer roles. <a href="mailto:ahmed.khaled1106@gmail.com" className="text-secondary-300 font-bold hover:border-secondary-300 hover:border-b-2">Let's connect.</a></h3>
			<div className="h-10 flex justify-center mt-10 gap-5 [&>a]:fill-white [&>a]:hover:fill-secondary-300">
